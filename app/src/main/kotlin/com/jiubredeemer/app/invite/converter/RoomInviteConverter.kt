package com.jiubredeemer.app.invite.converter

import com.jiubredeemer.app.invite.exception.BrokenInviteException
import com.jiubredeemer.app.invite.model.request.InviteUserToRoomRequest
import com.jiubredeemer.app.invite.model.response.OwnerDto
...
class RoomInviteConverter {
    ...
    private fun roomDtoToInviteRoomDto(roomUserInviteDto: RoomUserInviteDto) =
        com.jiubredeemer.app.invite.model.response.RoomDto(
