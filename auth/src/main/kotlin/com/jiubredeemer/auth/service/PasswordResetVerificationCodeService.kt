...
import com.jiubredeemer.dal.repository.PasswordResetEmailCodeRepository
...
@Service
class PasswordResetVerificationCodeService(
    private val repository: PasswordResetEmailCodeRepository,
    ...
    fun sendVerificationCode(rawEmail: String) {
        ...
        if (userRepository.findByEmailIgnoreCase(normalized) == null) {
        ...
        val entity = existing ?: PasswordResetEmailCode()
        ...
        mailService.sendPasswordResetCode(trimmed, plainCode)
    }
